...
# Docker Recipe File: Docker/el7-miniconda-ufs_pyutils.dockerfile
...
#    user@host:$ docker build -f el7-miniconda-ufs_pyutils.dockerfile --tag <DOCKER LOGIN>/el7-miniconda-ufs_pyutils:<TAG> .
...
LABEL noaaufsrnr/el7-miniconda-ufs_pyutils.image.authors="Henry.Winterbottom@noaa.gov"
